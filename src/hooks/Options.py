...
#
class SockCount(Range):
    """Decides how many of Dobby's Socks will be placed in the multiworld. 100% are required to win."""
    display_name = "Number of Dobby's Socks placed"
    range_start = 3
    range_end = 50
    default = 7
